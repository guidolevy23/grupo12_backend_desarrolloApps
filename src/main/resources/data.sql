...
-- First, insert sedes (branches) data
INSERT IGNORE INTO sedes (id, nombre, direccion, lat, lng)
VALUES
...
-- Then, insert course data with proper foreign key references
INSERT IGNORE INTO course (id, name, description, professor, branch_id, starts_at, ends_at)
VALUES
